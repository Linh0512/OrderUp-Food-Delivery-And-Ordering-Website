  ...
  return (
    <div className="w-[60vw] mx-auto">
      ...
      <div className="flex justify-between">
        <div className="grid grid-cols-2 w-[60%] gap-10 border p-4 rounded-2xl">
        ...
        <div className="flex flex-col items-center space-y-4 w-[40%]">
          ...
          <div className="flex space-x-4">
            ...
            <button className="border border-gray-400 px-4 py-2 rounded text-sm hover:bg-gray-100 transition">
              Xoá
            </button>
          </div>
        </div>
